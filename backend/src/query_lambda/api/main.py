...
from query_lambda.retrieval.planner import planner
from query_lambda.retrieval.response_builder import build_fast_path_response
...
def query_endpoint(req: QueryRequest):
    import hashlib
    from shared.db.redis_cache import cache
    from shared.config import CACHE_MIN_CONFIDENCE, CACHE_TTL_SECONDS
    from query_lambda.graph.langgraph_pipeline import pipeline
